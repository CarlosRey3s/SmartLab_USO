    ...
    <div className="content">
      ...
      <div className="main">
        ...
        <div className="panel espacios">
          <div className="panel-header">Espacios Ocupados</div>
          <div className="counter">
      ...
      <div className="dashboard-bottom">
        ...
        <div className="card">
          ...
          <div className="chart-container">
            ...
            <div className="bars-wrapper">
              ...
              {dashboard.reservas.map((item, index) => (
          ...
          <div className="alerts-list">
            ...
            {dashboard.alertas.map((alerta, index) => (
              ...
              <div className="alert-item" key={index}>
                ...
                <div className={`status-dot ${alerta.tipo}`} />
        ...
        <div className="card">
          ...
          <div className="agenda-list">
            ...
            {dashboard.agenda.map((item, index) => (
          ...
          <div className="agenda-list">
            ...
            {dashboard.agendaSemana.map((item, index) => (
