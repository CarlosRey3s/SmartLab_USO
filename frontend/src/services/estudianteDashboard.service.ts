// src/services/estudianteDashboard.service.ts
...
const getAuthHeaders = () => {
    ...
    const token =
        localStorage.getItem("uso_token");
...
export const obtenerDashboardEstudiante =
    async (): Promise<EstudianteDashboard> => {
        ...
        try {
            ...
            // Si el backend responde directamente:
            // {...}
            ...
            console.error(
                "Error al obtener dashboard del estudiante:",
                error
            );
