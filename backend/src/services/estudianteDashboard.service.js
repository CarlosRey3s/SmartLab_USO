const { obtenerTodasSolicitudes } = require('./actividades.service');
const obtenerDashboardEstudiante = async (usuarioId, rol) => {
    ...
    try {
        ...
        const resultado = await obtenerTodasSolicitudes(usuarioId, rol, null, 1, 100);
        ...
        console.error('Error en obtenerDashboardEstudiante:', error);
        throw error;
    }
};
// =========================================================
